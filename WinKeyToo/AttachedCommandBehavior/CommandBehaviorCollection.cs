...
namespace WinKeyToo.AttachedCommandBehavior
{
    internal class CommandBehaviorCollection
    {
        #region Behaviors
    ...
    /// </summary>
    internal class BehaviorBindingCollection : FreezableCollection<BehaviorBinding>
    {
        /// <summary>
